...
import ejercicio8excepciones.espectadores.DineroEspectadorException;
import ejercicio8excepciones.espectadores.EdadEspectadorException;
import ejercicio8excepciones.espectadores.Espectador;
import ejercicio8excepciones.espectadores.EspectadorException;
import ejercicio8excepciones.espectadores.NombreEspectadorException;
import ejercicio8excepciones.peliculas.DirectorPeliculaException;
import ejercicio8excepciones.peliculas.DuracionPeliculaException;
import ejercicio8excepciones.peliculas.EdadMinimaPeliculaException;
import ejercicio8excepciones.peliculas.Pelicula;
import ejercicio8excepciones.peliculas.PeliculaException;
import ejercicio8excepciones.peliculas.TituloPeliculaException;

public class Ejercicio8Excepciones {
	/*
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			// Espectador esp = new Espectador("dfdd", -4, 5);
		...
		} catch (NombreEspectadorException e) {
			System.out.println("Revisa el nombre, por favor.");
		} catch (EdadEspectadorException e) {
			System.out.println("Revisa la edad, por favor.");
		} catch (DineroEspectadorException e) {
			System.out.println("Revisa el dinero, por favor.");
	...
	public static Pelicula generarPelicula() throws TituloPeliculaException, DuracionPeliculaException,
			EdadMinimaPeliculaException, DirectorPeliculaException {
	...
	public static Espectador generarEspectador() throws EspectadorException {
